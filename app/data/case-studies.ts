export const caseStudies = [
  {
    ...
    outcomes: ['Predictable execution', 'Premium production standards', 'Scalable operating model'],
    gallery: [
  ...
  },
  {
    ...
    summary:
      'Pura Tinta Fest is a large-scale cultural convention that demands operational precision across complex attendee flows, exhibitor needs, and continuous programming. XR Studio executes the event as a controlled system—balancing experience, safety, vendor logistics, and content capture.',
    scope: [
  ...
  },
  {
    ...
    summary:
      'Blockchain Jungle is a multi-stakeholder conference environment requiring precise timing, speaker management, and reliable technical production. XR Studio runs the operational backbone—ensuring sessions, stages, and show flow execute cleanly for partners, speakers, and attendees.',
    scope: [
    ...
    gallery: ['/images/bcjungle-19.webp', '/images/bcjungle-28.webp', '/images/bcjungle-7.webp'],
  },
  {
    slug: 'magflow',
    name: 'Magflow',
    ...
    summary:
      'Magflow is a culture and music platform that translates into live experiences and content-driven programming. XR Studio supports execution with production discipline and captures content designed to extend impact beyond event day.',
    scope: [
    ...
    outcomes: ['Consistent delivery', 'High-quality content assets', 'Repeatable formats'],
    gallery: [
  ...
  },
  {
    ...
    summary:
      'Sweetspot competitions require a different type of precision: competitive integrity, technical reliability, and audience-ready execution. XR Studio operates events with structured workflows—ensuring brackets, timing, production cues, and onsite experience run smoothly.',
    scope: [
    ...
    gallery: ['/images/ss_img_0083.webp', '/images/ss_img_0128.webp', '/images/ss_img_0238.webp'],
  },
];
