export const services = [
  {
    ...
    description: "Experience Execution is our core offering—comprehensive production management that takes your event from concept to completion. We handle every operational detail so you can focus on the experience itself.",
    icon: "01",
    includes: [
  ...
  },
  {
    ...
    description: "We design and specify the technical infrastructure that brings your vision to life. From audio and lighting to video systems and stage construction, we ensure every technical element serves the experience.",
    icon: "02",
    includes: [
  ...
  },
  {
    ...
    description: "Our on-site operations team ensures flawless execution when it matters most. We coordinate crews, manage logistics, and make real-time decisions to keep your event running smoothly.",
    icon: "03",
    includes: [
  ...
  },
  {
    ...
    description: "We capture your event in its best light, creating content that extends its impact far beyond the venue. From live streaming to documentary-style coverage, we deliver assets that tell your story.",
    icon: "04",
    includes: [
  ...
  },
  {
    ...
    description: "Every event is an opportunity to learn and improve. We capture data, gather feedback, and deliver insights that help you optimize future productions and demonstrate ROI to stakeholders.",
    icon: "05",
    includes: [
